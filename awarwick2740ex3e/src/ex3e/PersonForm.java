...
public class PersonForm extends JFrame {
	...
	public PersonForm() {
		...
		if (!fileIsOpen){
			outputLabel.setText("File was not Opened");
		}
	...
	protected void do_personButton_actionPerformed(ActionEvent e) {
		...
		this.outputLabel.setText(strOutput + person.toString() + "<br></html>" );
	...
	protected void do_this_windowClosing(WindowEvent arg0) { // -----------------ex3e mod-------------------------
		Person.closeFile();
	}
